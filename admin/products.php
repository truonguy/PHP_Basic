    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
                ...
                ?>
                <p class="text-center" style="color: red;"><?php echo $_GET['edit_success_message']; ?></p>
                <?php }?>
                    ...
                    <table class="table table-striped table-sm">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="edit_product.php?product_id=<?php echo $product['product_id'];?>"
                                        class="btn btn-primary">Edit</a></td>
                                <td><a href="delete_product.php?product_id=?<?php echo $product['product_id']; ?>"
